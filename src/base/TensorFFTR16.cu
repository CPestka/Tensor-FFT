...
__global__ void TensorRadix16(__half2* input_data,
  ...
  //4 dynamic shared memory buffers
   extern __shared__ __half shared_buffer3[];
   int warp_shared_memory_offset = 768 * inter_block_warp_id;
   __half* buffer_RE = shared_buffer3 + warp_shared_memory_offset;
   __half* buffer_IM = shared_buffer3 + warp_shared_memory_offset + 256;
   __half* buffer_tmp_RE = shared_buffer3 + warp_shared_memory_offset + 512;
